defmodule Turbopuffer.Client do
  ...
  def new(opts) do
    ...
    if is_nil(api_key) do
      raise ArgumentError, "API key is required. Pass :api_key option or set TURBOPUFFER_API_KEY environment variable"
    end
  ...
  """
  @spec request(t(), atom(), String.t(), map() | nil, keyword()) :: response()
